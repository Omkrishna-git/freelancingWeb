...
const Features = () => {
  return (
    <div className="bg-gray-100 py-12 px-6 md:px-12">
      ...
      {/* -------------------- Second Section -------------------- */}
      <section className="bg-[#42554c] rounded-3xl px-10 py-16 text-center max-w-4xl mx-auto mt-16">
        <h2 className="text-4xl md:text-4xl font-bold text-[#ffffff]">
          Things for freelancers
        </h2>
        <p className="text-3xl md:text-2xl mt-2 font-medium text-[#9bbaac]">
          sent to your inbox weekly
        </p>

        <form className="mt-8 text-[#bddecf] flex flex-col sm:flex-row items-center justify-center gap-4">
          <input
            type="email"
